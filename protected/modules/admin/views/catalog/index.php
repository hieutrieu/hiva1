		...
		$this->widget('zii.widgets.grid.CGridView', array(
			...
			'columns' => array(		
				...
				array(
					...
					'value' => 'str_repeat(\'<span class="gi">|&mdash;&mdash;</span>\', $data->level-1) . CHtml::link($data->title, Yii::app()->createUrl("/admin/catalog/edit/", array("id"=>$data["id"]))).\'<p class="smallsub">\'. str_repeat(\'<span class="gtr"></span>\', $data->level-1)',
					'type' => 'raw',
				),
				'description:html',
				array(
