<?php
$this->button = array(
	array('label'=>Yii::t('app', 'Add'), 'url'=>array('index'), 'htmlOptions' => array('class' => 'fa fa-plus-square-o', 'id' => 'new-button')),
	array('label'=>Yii::t('app', 'Remove'), 'url'=>array('removehot'), 'htmlOptions' => array('class' => 'fa fa-minus-square-o', 'id' => 'remove-button')),
);
