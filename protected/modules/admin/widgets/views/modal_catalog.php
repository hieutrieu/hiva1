...
<a href="<?php echo Yii::app()->createUrl('/admin/catalog', array('tmpl' => 'modal', 'function' => 'mSelectCategory'. $id)) ?>" onclick="" class="button fancybox fancybox.iframe"><?php echo Yii::t('app', 'Select Catalog')?></a>
