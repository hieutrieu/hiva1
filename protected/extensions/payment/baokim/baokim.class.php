...
// URL checkout của baokim.vn
	...
	// Mã merchante site 
	private $merchant_id = '577';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = 'ebc9f951ea3020e8'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
	
	public function __construct() {
		$baokimConfig = PaymentClass::getConfig('baokim');
		
		$this->baokim_url 		= $baokimConfig->CHECKOUT_URL;
		$this->merchant_id	 	= $baokimConfig->MERCHANT_SITE_CODE;
		$this->secure_pass		= $baokimConfig->SECURE_PASS;
	}
