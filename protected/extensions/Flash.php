...
class Flash extends CWidget
{
	 ...
	 */
	public $keys = array('success', 'error', 'notice', 'warning');
	/**
	 * @property string the template to use for displaying flash messages.
	 */
	public $template = '<div class="alert alert-{key} alert-dismissable">
        <i class="fa fa-ban"></i>
        {message}
	 ...
	 */
	public $js = "jQuery('#{id}').animate({opacity: 1.0}, 5000).fadeOut('slow');";
